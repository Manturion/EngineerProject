...
public class CreateOfferDto extends OfferDtoTemplate {
    ...
    public CreateOfferDto(String title, String description, String image, BigDecimal oldPrice, BigDecimal newPrize, BigDecimal gps, Date startDate, Date expireDate, boolean isAvailable, Long categoryId) {
