...
public interface OfferRepository extends JpaRepository<OfferEntity, Long> {
    ...
    @Query("select new pl.pollub.inzynierka.infrastructure.Offer.OfferDto(o.title,o.description,o.image,o.oldPrice,o.newPrize,o.gps,o.startDate,o.expireDate,o.isAvailable,o.categoryByCategoryId.id, o.id) from OfferEntity o ")
